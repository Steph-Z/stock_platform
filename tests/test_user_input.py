...
#Test for the helper functions , unit tests. To test these I first wrote them up as individsual functions
#In a next step i grouped tests of the same kind of function into classes. 

class TestCleaing_user_input:
    '''Unit tests for the cleanp functions'''
    ...
    def test_input_case_insensitive(self, raw, expected):
    ...
    def test_remove_dashes(self, raw, expected):
        '''tests the function, should strip and delete all spaces or tabs'''
        assert remove_dashes(raw) == expected
    

class Test_Isin_ticker_validation:
    '''Tests for ticker and isin validation'''
    ...
    def test_isValid_ISIN_Code(self, isin, valid):
    ...
    def test_check_luhn_computes_checksum_correctly(self, isin, valid):
        '''
    ...
    def test_check_ticker_with_injected_fake(self, fake_ticker, symbol, expected):
        '''
...
class Test_integration_whole_isin_ticker_cheker:
    '''tests the whole pipeline/function '''
    ...
    def test_check_isin_ticker_input_end_to_end(self, fake_ticker, user_input, expected):
        """
